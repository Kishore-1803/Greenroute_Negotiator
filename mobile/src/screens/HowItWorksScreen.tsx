        ...
        >
          ...
          <GlassCard style={styles.sectionCard} variant="dark">
            ...
            <View style={styles.metricExtractionList}>
              <View style={styles.extractItem}>
                ...
                <Text style={styles.extractText}>Extract Time</Text>
              </View>
              <View style={styles.extractItem}>
                <IndianRupee size={14} color={colors.primaryBright} />
                <Text style={styles.extractText}>Calculate Direct Cost</Text>
              </View>
              <View style={styles.extractItem}>
                <Leaf size={14} color={colors.primaryBright} />
                <Text style={styles.extractText}>Quantify Emissions</Text>
              </View>
            </View>
          </GlassCard>
          ...
          <GlassCard style={styles.sectionCard} variant="dark">
            ...
            <View style={styles.objectionHighlightBox}>
              ...
              <Text style={styles.objectionHighlightText}>Objection Handling</Text>
            </View>
          </GlassCard>
